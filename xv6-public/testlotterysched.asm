...
_testlotterysched:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  18:	68 02 02 00 00       	push   $0x202
  1d:	68 69 09 00 00       	push   $0x969
  22:	e8 2c 04 00 00       	call   453 <open>
    int fd2 = open("f2", O_CREATE|O_RDWR);
  27:	59                   	pop    %ecx
  28:	5e                   	pop    %esi
  29:	68 02 02 00 00       	push   $0x202
  2e:	68 6c 09 00 00       	push   $0x96c
    int fd1 = open("f1", O_CREATE|O_RDWR);
  33:	89 c3                	mov    %eax,%ebx
    int fd2 = open("f2", O_CREATE|O_RDWR);
  35:	e8 19 04 00 00       	call   453 <open>
  ...
  43:	68 6f 09 00 00       	push   $0x96f
  48:	e8 06 04 00 00       	call   453 <open>
  4d:	89 c7                	mov    %eax,%edi
      
    if ((pid1 = fork()) == 0) {
  4f:	e8 b7 03 00 00       	call   40b <fork>
  54:	83 c4 10             	add    $0x10,%esp
  57:	85 c0                	test   %eax,%eax
  59:	75 1f                	jne    7a <main+0x7a>
        int pp1 = getpid();
  5b:	e8 33 04 00 00       	call   493 <getpid>
        settickets(10);
  ...
  65:	89 c6                	mov    %eax,%esi
        settickets(10);
  67:	e8 4f 04 00 00       	call   4bb <settickets>
        spin();
	printpinfo(pp1, fd1);
  6c:	58                   	pop    %eax
  6d:	5a                   	pop    %edx
  6e:	53                   	push   %ebx
  6f:	56                   	push   %esi
  70:	e8 9b 00 00 00       	call   110 <printpinfo>
        exit(); 
  75:	e8 99 03 00 00       	call   413 <exit>
    }
    else if ((pid2 = fork()) == 0) {
  7a:	e8 8c 03 00 00       	call   40b <fork>
  7f:	85 c0                	test   %eax,%eax
  81:	75 1f                	jne    a2 <main+0xa2>
        int pp2 = getpid();
  83:	e8 0b 04 00 00       	call   493 <getpid>
        settickets(20);
  ...
  8d:	89 c3                	mov    %eax,%ebx
        settickets(20);
  8f:	e8 27 04 00 00       	call   4bb <settickets>
        spin();
	printpinfo(pp2, fd2);
  94:	59                   	pop    %ecx
  95:	5f                   	pop    %edi
  96:	56                   	push   %esi
  97:	53                   	push   %ebx
  98:	e8 73 00 00 00       	call   110 <printpinfo>
        exit();
  9d:	e8 71 03 00 00       	call   413 <exit>
    }
    else if ((pid3 = fork()) == 0) {
  a2:	e8 64 03 00 00       	call   40b <fork>
  a7:	85 c0                	test   %eax,%eax
  a9:	75 1f                	jne    ca <main+0xca>
        int pp3 = getpid();
  ab:	e8 e3 03 00 00       	call   493 <getpid>
        settickets(100);
  ...
  b5:	89 c3                	mov    %eax,%ebx
        settickets(100);
  b7:	e8 ff 03 00 00       	call   4bb <settickets>
        spin();
	printpinfo(pp3, fd3);
  bc:	58                   	pop    %eax
  bd:	5a                   	pop    %edx
  be:	57                   	push   %edi
  bf:	53                   	push   %ebx
  c0:	e8 4b 00 00 00       	call   110 <printpinfo>
        exit();
  c5:	e8 49 03 00 00       	call   413 <exit>
    }
    wait();
  ca:	e8 4c 03 00 00       	call   41b <wait>
    wait();
  cf:	e8 47 03 00 00       	call   41b <wait>
    wait();
  d4:	e8 42 03 00 00       	call   41b <wait>
    close(fd1);
  d9:	83 ec 0c             	sub    $0xc,%esp
  dc:	53                   	push   %ebx
  dd:	e8 59 03 00 00       	call   43b <close>
    close(fd2);
  e2:	89 34 24             	mov    %esi,(%esp)
  e5:	e8 51 03 00 00       	call   43b <close>
    close(fd3);
  ea:	89 3c 24             	mov    %edi,(%esp)
  ed:	e8 49 03 00 00       	call   43b <close>
    exit();
  f2:	e8 1c 03 00 00       	call   413 <exit>
  f7:	66 90                	xchg   %ax,%ax
  f9:	66 90                	xchg   %ax,%ax
  fb:	66 90                	xchg   %ax,%ax
  fd:	66 90                	xchg   %ax,%ax
...
00000110 <printpinfo>:
{
 ...
 117:	b9 00 01 00 00       	mov    $0x100,%ecx
{
 11c:	89 e5                	mov    %esp,%ebp
 11e:	57                   	push   %edi
 11f:	56                   	push   %esi
	struct pstat pi = {0};
 120:	8d bd e8 fb ff ff    	lea    -0x418(%ebp),%edi
{
 126:	53                   	push   %ebx
	getpinfo(&pi);
 127:	8d 9d e8 fb ff ff    	lea    -0x418(%ebp),%ebx
{
 12d:	81 ec 18 04 00 00    	sub    $0x418,%esp
 133:	8b 75 08             	mov    0x8(%ebp),%esi
	struct pstat pi = {0};
 136:	f3 ab                	rep stos %eax,%es:(%edi)
	getpinfo(&pi);
 138:	53                   	push   %ebx
 139:	8d bd e8 fc ff ff    	lea    -0x318(%ebp),%edi
 13f:	e8 7f 03 00 00       	call   4c3 <getpinfo>
    for (i = 0; i < NPROC; i++) {
 144:	83 c4 10             	add    $0x10,%esp
 147:	eb 0e                	jmp    157 <printpinfo+0x47>
 149:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 150:	83 c3 04             	add    $0x4,%ebx
 153:	39 fb                	cmp    %edi,%ebx
 155:	74 4e                	je     1a5 <printpinfo+0x95>
        if(pi.pid[i] == pid) {
 157:	39 b3 00 02 00 00    	cmp    %esi,0x200(%ebx)
 15d:	75 f1                	jne    150 <printpinfo+0x40>
		printf(fd, "Number of tickets that PID %d has: %d\n", pid, pi.tickets[i]);
 15f:	ff b3 00 01 00 00    	pushl  0x100(%ebx)
 165:	83 c3 04             	add    $0x4,%ebx
 168:	56                   	push   %esi
 169:	68 e8 08 00 00       	push   $0x8e8
 16e:	ff 75 0c             	pushl  0xc(%ebp)
 171:	e8 0a 04 00 00       	call   580 <printf>
	        printf(fd, "Number of ticks that PID %d has: %d\n", pid, pi.ticks[i]);
 176:	ff b3 fc 02 00 00    	pushl  0x2fc(%ebx)
 17c:	56                   	push   %esi
 17d:	68 10 09 00 00       	push   $0x910
 182:	ff 75 0c             	pushl  0xc(%ebp)
 185:	e8 f6 03 00 00       	call   580 <printf>
	        printf(fd, "Is the process with PID %d in use? (0 or 1): %d\n", pid, pi.inuse[i]);
 18a:	83 c4 20             	add    $0x20,%esp
 18d:	ff 73 fc             	pushl  -0x4(%ebx)
 190:	56                   	push   %esi
 191:	68 38 09 00 00       	push   $0x938
 196:	ff 75 0c             	pushl  0xc(%ebp)
 199:	e8 e2 03 00 00       	call   580 <printf>
 19e:	83 c4 10             	add    $0x10,%esp
    for (i = 0; i < NPROC; i++) {
 1a1:	39 fb                	cmp    %edi,%ebx
 1a3:	75 b2                	jne    157 <printpinfo+0x47>
}
...
printf(int fd, const char *fmt, ...)
{
 ...
 704:	eb 1a                	jmp    720 <printf+0x1a0>
          s = "(null)";
 706:	bb 72 09 00 00       	mov    $0x972,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 755:	a1 74 0c 00 00       	mov    0xc74,%eax
{
 ...
 776:	73 10                	jae    788 <free+0x38>
{
 ...
 7a1:	5b                   	pop    %ebx
  freep = p;
 7a2:	a3 74 0c 00 00       	mov    %eax,0xc74
}
 7a7:	5e                   	pop    %esi
 7a8:	5f                   	pop    %edi
 7a9:	5d                   	pop    %ebp
 ...
 7c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7ca:	a3 74 0c 00 00       	mov    %eax,0xc74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7f0:	8b 3d 74 0c 00 00    	mov    0xc74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 839:	8b 3d 74 0c 00 00    	mov    0xc74,%edi
 ...
 862:	e8 e9 fe ff ff       	call   750 <free>
  return freep;
 867:	a1 74 0c 00 00       	mov    0xc74,%eax
 ...
 894:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 897:	a3 74 0c 00 00       	mov    %eax,0xc74
}
 ...
 8ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8b0:	c7 05 74 0c 00 00 78 	movl   $0xc78,0xc74
 8b7:	0c 00 00 
    base.s.size = 0;
 8ba:	bf 78 0c 00 00       	mov    $0xc78,%edi
    base.s.ptr = freep = prevp = &base;
 8bf:	c7 05 78 0c 00 00 78 	movl   $0xc78,0xc78
 8c6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8cb:	c7 05 7c 0c 00 00 00 	movl   $0x0,0xc7c
 8d2:	00 00 00 
    if(p->s.size >= nunits){
